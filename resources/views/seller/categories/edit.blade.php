        ...
        <div class="relative text-center py-8 md:py-12 px-4 md:px-6 rounded-2xl md:rounded-3xl bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50 dark:from-primary-900/30 dark:via-secondary-900/30 dark:to-accent-900/30 border-2 border-primary-200 dark:border-primary-700 shadow-xl">
            <div class="relative z-10">
                <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-3 md:mb-4 bg-gradient-to-r from-primary-600 via-secondary-600 to-accent-600 dark:from-primary-400 dark:via-secondary-400 dark:to-accent-400 bg-clip-text text-transparent drop-shadow-sm">
                    ✏️ {{ __('messages.edit') }} {{ __('messages.categories') }}
                </h1>
                <p class="text-base md:text-xl text-slate-700 dark:text-slate-300 font-bold">{{ __('messages.update_category_info') }}</p>
            </div>
        </div>
    </div>
        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 md:p-8 border-2 border-gray-200 dark:border-gray-700">
            <form action="{{ route('seller.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="relative bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50 dark:from-gray-900 dark:to-gray-800 rounded-xl p-6 border-2 border-primary-200 dark:border-primary-700">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="name_uz" id="name_uz" required value="{{ old('name_uz', $category->name_uz ?? $category->name) }}" class="w-full border-2 border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 text-slate-900 dark:text-white bg-white dark:bg-gray-700 font-bold focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('name_uz') border-red-500 @enderror">
                                @error('name_uz')
                            ...
                            <div>
                                ...
                                <input type="text" name="name_en" id="name_en" required value="{{ old('name_en', $category->name_en ?? $category->name) }}" class="w-full border-2 border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 text-slate-900 dark:text-white bg-white dark:bg-gray-700 font-bold focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('name_en') border-red-500 @enderror">
                                @error('name_en')
                                    <p class="text-red-600 dark:text-red-400 text-sm mt-2 font-extrabold">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="relative bg-gradient-to-br from-secondary-50 via-accent-50 to-primary-50 dark:from-gray-900 dark:to-gray-800 rounded-xl p-6 border-2 border-secondary-200 dark:border-secondary-700">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="description_ru" id="description_ru" rows="4" class="w-full border-2 border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 text-slate-900 dark:text-white bg-white dark:bg-gray-700 font-medium focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500 @error('description_ru') border-red-500 @enderror">{{ old('description_ru', $category->description_ru ?? $category->description) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="description_en" id="description_en" rows="4" class="w-full border-2 border-gray-300 dark:border-gray-600 rounded-xl px-4 py-3 text-slate-900 dark:text-white bg-white dark:bg-gray-700 font-medium focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500 @error('description_en') border-red-500 @enderror">{{ old('description_en', $category->description_en ?? $category->description) }}</textarea>
                ...
                <div class="relative mb-6">
                    ...
                    <div class="relative bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:to-gray-800 rounded-xl p-6 border-2 border-blue-200 dark:border-blue-700">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="w-32 h-32 bg-gradient-to-br from-gray-100 via-gray-50 to-white dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 rounded-xl border-2 border-gray-300 dark:border-gray-600 shadow-md flex items-center justify-center p-2">
                                <img src="{{ asset('storage/' . $category->image) }}" alt="{{ $category->localized_name }}" id="current-image" class="max-w-full max-h-full object-contain">
                            </div>
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div id="image-preview" class="hidden">
                                    <div class="w-20 h-20 bg-gradient-to-br from-gray-100 via-gray-50 to-white dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 rounded-xl border-2 border-gray-300 dark:border-gray-600 shadow-md flex items-center justify-center p-1">
                        ...
                        if (file) {
                            ...
                            reader.onload = function(e) {
                                ...
                                if (document.getElementById('current-image')) {
                                    document.getElementById('current-image').parentElement.classList.add('opacity-50');
                                }
                                @endif
                            };
                            ...
                            @if($category->image)
                            if (document.getElementById('current-image')) {
                                document.getElementById('current-image').parentElement.classList.remove('opacity-50');
                            }
                            @endif
                        }
                    });
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('seller.categories.index') }}" class="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-slate-900 dark:text-white px-8 py-4 rounded-xl font-extrabold shadow-lg transition-all duration-300">
                        {{ __('messages.cancel') }}
                    </a>
                </div>
            </form>
