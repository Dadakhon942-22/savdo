...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold">{{ __('messages.categories') }}</h1>
        <a href="{{ route('admin.categories.create') }}" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.categories.edit', $category) }}" class="flex-1 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 text-center">
                        {{ __('messages.edit') }}
                    </a>
