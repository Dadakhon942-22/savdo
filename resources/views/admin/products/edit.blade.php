        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 md:p-8 border-2 border-gray-200 dark:border-gray-700">
            <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-slate-900 dark:text-white px-8 py-4 rounded-xl font-extrabold shadow-lg transition-all duration-300">
                        {{ __('messages.cancel') }}
                    </a>
                </div>
            </form>
